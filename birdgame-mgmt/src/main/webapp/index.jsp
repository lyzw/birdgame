...
<html lang="zh_cn">
	<head>
		...
		<base href="<%=basePath%>">
		<meta charset="utf-8">
		<title> 嗨淘数据中心 -- 经分系统、日志查询、监控报警、行为数据分析</title>
	...
	<body class="">
		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="logoff" title="退出" data-action="userLogout" data-logout-msg="关闭浏览器并不会退出账户,为确保数据安全,请您及时退出账户.要退出吗?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is -->
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="img/avatars/user.png" alt="me" class="online" />
						<span>
							${displayname}
						</span>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<span class="ribbon-button-alignment">
					<span id="refresh" class="btn btn-ribbon" data-action="resetWidgets" data-title="refresh" rel="tooltip" data-placement="bottom" data-original-title="<i class='text-warning fa fa-warning'></i> 警告! 会重置所有本地插件设置." data-html="true" data-reset-msg="你想重置你所有本地保存的插件设置吗?"><i class="fa fa-refresh"></i></span>
				</span>
		...
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white"> © mgmt.birdgame.mobi 2016 </span>
				</div>

				<div class="col-xs-6 col-sm-6 text-right hidden-xs">
					<div class="txt-color-white inline-block">
						<i class="txt-color-blueLight hidden-mobile"><i class="fa fa-phone"></i> 技术支持: </strong> </i>
		...
		<script src="js/jgridloader.js"></script>
		...
		<script src="js/plugin/flot/jshashtable-2.1.js"></script>
		<script src="js/plugin/flot/jquery.numberformatter-1.2.3.min.js"></script>
		<script src="js/plugin/flot/jquery.flot.axislabels.js"></script>
		<script src="js/plugin/flot/jquery.flot.symbol.js"></script>
